...
<head>
    ...
    <title>Search All Customers</title>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#">Search all Customers <span class="sr-only"></span></a></li>
                <li class="dropdown">
...
<div class="container">
    ...
    <a href="newCustomer.php">
        <button id="alterationForm" type="button" name="alterationForm" class="btn btn-lg">Add New Customer
        </button>
    </a>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card mt-4">
                <div class="card-header">
                    <h4 class="heading">Search All Customers</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-7">
                                ...
                                <div class="input-group lg-3 ">
                                    <label>
                                        <input type="search" name="search" size="50"
                                               ...
                                               placeholder="Search all by Name or Number">
                                    </label>

                                </div>
                                <button type="submit" class="btn btn dalt">Search</button>
                            </form>
                ...
                <div class="card-body">
                    <table class="table table-hover altTable" >
                        ...
                        if (isset($_GET['search'])) {
                            ...
                            $query = "SELECT * FROM customerdetails WHERE CONCAT(customerName,customerNumber,status) LIKE '%$filtervalues%'";
                            $query_run = mysqli_query($con, $query);

                            if (mysqli_num_rows($query_run) > 0) {
                                foreach ($query_run as $items) {
                                    ?>
                                    <tr <?php echo "data-href='customerDetails.php?ID={$items['customerID']}'"; ?>>
