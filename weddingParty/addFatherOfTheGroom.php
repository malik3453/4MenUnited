...
while ($rowData = ($partySql)->fetch_assoc()) {
    ...
    $groomsmanStyle = $rowData['fatherOfTheGroomStyle'];
...
if (isset($_POST['submit'])) {
    $individual = mysqli_real_escape_string($con, "Father of the Groom");
    ...
    $cus_insert = "insert into customerdetails (customerID, customerName, customerNumber, status, date,notes,salesPerson,suit,suitSize,suitColor,suitFit,pantSize,shirtType,shirtSize,vest,type)
VALUES ('$cusID','$name','$number','$status','$date','$notes','$salesPerson','$suit','$suitSize','$suitDetials','$suitFit','$pantSize','$shirtType','$shirtSize','$vestSize','$type')";
...
if (isset($_POST['order'])) {
    ...
    $notes = $groomName . "'s Party (Father of the Groom)";
    if ($pantSize == "") {
        $pantSize = $suitSize - 7;
    }
    if ($suitSize == "0" || $suitSize == "") {
    ...
    while ($rowData = ($getorder)->fetch_assoc()) {
        ...
        $max = $prefix . "#" . $max;
        $orderNotes = mysqli_real_escape_string($con, "Father of the Groom - " . $groomName . "'s Party");;
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#">Father of the Groom - <?php echo $groomName ?>'s party <span
...
<div class="container">
    ...
    <form autocomplete="off" method="post" class="form-horizontal">
        <fieldset>
            ...
            <h4 class="text-center heading">Add Groom's Father Details</h4>


            <!-- Text input-->
            <div class="form-group">
                <label class="col-md-4 control-label" for="Name">Father of the Groom's Name:</label>
                <div class="col-md-4">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label" for="number">Father of the Groom's Number:</label>
                <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <select id="suit" name="suit" class="form-control">
                        <option value="<?php echo $fatherOfTheGroom ?>"><?php echo $fatherOfTheGroom ?> - Default
                        </option>
                        <?php
