...
if (isset($_POST['submit'])) {
    $individual = mysqli_real_escape_string($con, "Groomsman");
...
if (isset($_POST['order'])) {
    ...
    $notes = $groomName . "'s Party (Groomsman)";
    if ($pantSize == "") {
        $pantSize = $suitSize - 7;
    }
    if ($suitSize == "0" || $suitSize == "") {
    ...
    while ($rowData = ($getorder)->fetch_assoc()) {
        ...
        $max = $prefix . "#" . $max;
        $orderNotes = mysqli_real_escape_string($con, "Groomsman - " . $groomName . "'s Party");;
...
<div class="container">
    ...
    <form autocomplete="off" method="post" class="form-horizontal">
        <fieldset>
            ...
            <h4 class="text-center heading">Add Groomsman's Details</h4>


            <!-- Text input-->
            <div class="form-group">
                <label class="col-md-4 control-label" for="Name">Groomsman's Name:</label>
                <div class="col-md-4">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label" for="number">Groomsman's Number:</label>
                <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <select id="suit" name="suit" class="form-control">
                        <option value="<?php echo $groomsmenSuit ?>"><?php echo $groomsmenSuit ?> - Default</option>
                        <?php
