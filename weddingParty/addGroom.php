...
if (isset($_POST['submit'])) {
    $individual = mysqli_real_escape_string($con, "Groom");
...
if (isset($_POST['order'])) {
    ...
    while ($rowData = ($getorder)->fetch_assoc()) {
        ...
        $max = $prefix . "#" . $max;
        $orderNotes = mysqli_real_escape_string($con, "Groom - " . $groomName . "'s Party");;
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#">Groom - <?php echo $groomName ?>'s party <span
...
<div class="container">
    ...
    <form autocomplete="off" method="post" class="form-horizontal">
        <fieldset>
            ...
            <h4 class="text-center heading">Add Groom Details</h4>

            <!-- Text input-->
            <div class="form-group">
                <label class="col-md-4 control-label" for="Name">Groom's Name:</label>
                <div class="col-md-4">
                    <input id="Name" name="Name" value="<?php echo $groomName ?>" type="text" placeholder=""
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <select id="suit" name="suit" class="form-control">
                        <option value="<?php echo $groomSuit ?>"><?php echo $groomSuit ?> - Default</option>
                        <?php
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="Style" name="Style" type="text" value="<?php echo $groomStyle ?>"
                           placeholder="E.g: 201-1, Black, Blue plaid " class="form-control input-md" required="">
